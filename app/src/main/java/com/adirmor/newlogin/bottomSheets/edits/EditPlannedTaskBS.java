...
public class EditPlannedTaskBS extends BottomSheetDialog {
    ...
    public EditPlannedTaskBS(@NonNull Context context, int adapterPosition,
                             List<TaskModel> taskModels, PlannedTaskAdapter adapter) {
        super (context);
    ...
    private void EditTask(View view) {
        ...
        FirebaseUtils.getPlannedTaskModel ().whereEqualTo("id", taskModels.get (adapterPosition).getId ()).get().addOnCompleteListener(task -> {
